...
const SocialIcons = (props, context) => {
  ...
  return (
    ...
    <div className="social-icons animate-icons">
        {Info.github &&
          <a target="_blank" rel="noopener noreferrer" href={Info.github} style={ { color: colorPrimary } }><i className="fab fa-github"></i></a>
        }
        {Info.twitter &&
          <a target="_blank" rel="noopener noreferrer" href={Info.twitter} style={ { color: colorPrimary } }><i className="fab fa-twitter"></i></a>
        }
        {Info.stackoverflow &&
          <a target="_blank" rel="noopener noreferrer" href={Info.stackoverflow} style={ { color: colorPrimary } }><i className="fab fa-stack-overflow"></i></a>
        }
        {Info.linkedin &&
          <a target="_blank" rel="noopener noreferrer" href={Info.linkedin} style={ { color: colorPrimary } }><i className="fab fa-linkedin"></i></a>
        }
        {Info.medium &&
          <a target="_blank" rel="noopener noreferrer" href={Info.medium} style={ { color: colorPrimary } }><i className="fab fa-medium"></i></a>
        }
        {Info.dev &&
